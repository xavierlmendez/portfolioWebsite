            ...
            <div className='grid grid-cols-12 gap-6'>
                ...
                <div className='col-span-12 md:col-span-4'>
                    ...
                    to-gray-800/70 backdrop-blur-md shadow-xl p-4 md:p-5'>
                        <IndicatorManipulator indicators={indicators} showModal={showModal} onOpen={handleOpen}
                            onClose={handleClose} onAddIndicator={handleAddIndicator}
                            onRemove={handleRemove} newIndicator={newIndicator} setNewIndicator={setNewIndicator} />
                    </div>
                </div>
            </div>
